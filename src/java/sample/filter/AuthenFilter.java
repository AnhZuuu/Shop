    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            for (String value : NON_AUTHEN_RESOURCES) {
                if (uri.contains(".css") || uri.contains(".png") || uri.contains(".jpg")) {
            ...
            if (checkContain) {
                ...
                if (session == null || session.getAttribute("LOGIN_USER") == null) {
                    ...
                    if (AD.equals(roleID) && AD_RESOURCES.contains(resource)) {
                        ...
                        if (AD.equals(roleID)) {
                            req.getRequestDispatcher(ADMIN_PAGE).forward(request, response);
                        } else {
                            req.getRequestDispatcher(USER_PAGE).forward(request, response);
                        }
                    }
                }
            }
